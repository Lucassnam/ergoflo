...
export const PARTS = [
  {
    num: "01",
    title: "Dual brushless fans",
    body: "Two PWM-controlled fans flank the spine near the shoulder blades, each on its own rigid mount so vibration never reaches you.",
  },
  {
    num: "02",
...
export const SPECS = [
  ...
  ["Fans", "Dual brushless, PWM speed control"],
